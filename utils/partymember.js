...
import { timeToString, indexToFloor } from "../utils/calc"
...
export default class PartyMember {
    ...
    toString(floorIndex = 0, pb) {
        return ` ${this.name} | §6${this.dungeons.catalevel}§r | §a${this.dungeons.secrets}§r | §b${this.dungeons.secretAverage}§r | §9${pb ?? this.dungeons.pb["catacombs"]["7"]["S+"]}§r (§e${indexToFloor(floorIndex)}§r)`
    }
}
